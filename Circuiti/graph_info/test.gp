...
set ylabel '$V_{out}$ $[V]$'
plot '/home/matteo/Documenti/tesi/Circuiti/dat_files/test.dat' using 1:2 with lines ls 10 notitle
set ylabel '$V_{a}$ $[V]$'
plot '/home/matteo/Documenti/tesi/Circuiti/dat_files/test.dat' using 1:3 with lines ls 11 notitle
set xtics format "%g"
set xlabel 'tempo $[ns]$'
set ylabel '$V_{b}$ $[V]$'
plot '/home/matteo/Documenti/tesi/Circuiti/dat_files/test.dat' using 1:4 with lines ls 12 notitle
unset multiplot
