...
set ylabel '$V_{in,1}$'
plot '/home/matteo/Documenti/tesi/Circuiti/dat_files/nor-dinamica-corr.dat' using 1:3 with lines ls 11 notitle
set xtics format "%g"
set xlabel 'tempo $[ns]$'
set ylabel '$V_{in,2}$'
plot '/home/matteo/Documenti/tesi/Circuiti/dat_files/nor-dinamica-corr.dat' using 1:4 with lines ls 12 notitle
unset multiplot
...
set terminal epslatex size 10cm,5.5cm 
