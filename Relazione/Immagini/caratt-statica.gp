...
set label 2 '\ft $V_{gs}=1.8V$'		at 0.9,3.5 	rotate by 5 	center tc ls 1	
set label 3 '\ft $V_{gs}=1.5V$'		at 0.9,2.5 	rotate by 4 	center tc ls 1
set label 4 '\ft $V_{gs}=1.2V$'		at 0.9,1.5 	rotate by 3 	center tc ls 1
set label 5 '\ft $V_{gs}=0.9V$'		at 0.9,0.6 	rotate by 1 	center tc ls 1
set label 6 '\ft $V_{gs}<0.8V$'		at 0.9,-0.25 	rotate by 0 	center tc ls 1
